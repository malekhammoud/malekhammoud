...
<div style={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px', marginBottom: '20px' }}>
    ...
    <a href="https://robotics.malekhammoud.com/" target="_blank" style={{ color: '#007acc', fontWeight: 'bold' }}>robotics.malekhammoud.com</a>.
</div>
## INTRODUCTION
...
<iframe src="https://malekhammoud.com/Autonomous_Litter_Detection_and_Recovery_System.pdf#zoom=80&toolbar=1&navpanes=0" width="100%" height="600px">
