...
<Callout>
    To view a visual version of this article visit
    <a href="https://robotics.malekhammoud.com/" target="_blank" className="text-signal underline decoration-rule underline-offset-4" >robotics.malekhammoud.com</a>.
</Callout>
## INTRODUCTION
...
## A paper:
This is a <a href="https://malekhammoud.com/Autonomous_Litter_Detection_and_Recovery_System.pdf">paper</a> I wrote about a robotics project, enjoy!
<div>

<iframe src="/Autonomous_Litter_Detection_and_Recovery_System.pdf#zoom=80&toolbar=1&navpanes=0" title="Autonomous Litter Detection and Recovery System (PDF)" loading="lazy" width="100%" height="600px">
