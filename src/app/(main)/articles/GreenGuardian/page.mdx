...
import green from './greenguardian.png'
...
<Callout>
    ...
    <a href="https://partner.projectboard.world/ysc/project/greenguardian-automated-weed-detection-and-elimination" target="_blank" className="text-signal underline decoration-rule underline-offset-4" >ProjectBoard</a>.
    <iframe className="w-full" height="400" src="https://www.youtube-nocookie.com/embed/oWvfxRrFsdk" title="GreenGuardian project video" loading="lazy" allowFullScreen></iframe>
</Callout>
