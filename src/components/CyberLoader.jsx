...
export function CyberLoader({ isLoading }) {
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm rounded-inherit transition-opacity duration-500">
      ...
      <div className="relative flex flex-col items-center justify-center gap-4">
        <div className="relative w-14 h-14 flex items-center justify-center">
          {/* Outer ring */}
          <div className="absolute inset-0 border-[2px] border-zinc-200 dark:border-zinc-800 rounded-full" />
          ...
          {/* Middle ring */}
          <div className="absolute inset-2 border-[2px] border-zinc-200 dark:border-zinc-800 rounded-full" />
